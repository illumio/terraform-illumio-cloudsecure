...
* [`aws_flow_logs_s3_bucket_source`](https://registry.terraform.io/modules/illumio/cloudsecure/illumio/latest/submodules/aws_flow_logs_s3_bucket_source): registration of existing AWS S3 buckets with CloudSecure as flow log sources, by bucket name and optional path prefix.
...
* [`azure_flow_logs_storage_account_source`](https://registry.terraform.io/modules/illumio/cloudsecure/illumio/latest/submodules/azure_flow_logs_storage_account_source): registration of existing Azure Storage Accounts with CloudSecure as flow log sources, by storage account name and optional container name and path prefix.
...
* [`gcp_flow_logs_storage_bucket_source`](https://registry.terraform.io/modules/illumio/cloudsecure/illumio/latest/submodules/gcp_flow_logs_storage_bucket_source): registration of existing GCP Cloud Storage buckets with CloudSecure as flow log sources, by bucket name and optional path prefix.
