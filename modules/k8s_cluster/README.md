...
| <a name="input_https_proxy"></a> [https\_proxy](#input\_https\_proxy) | The URL of the HTTPS proxy to be used by cloud-operator to connect to Illumio CloudSecure. If not set, no proxy will be used. | `string` | `""` | no |
