...
| <a name="output_secret_expiration_days"></a> [secret\_expiration\_days](#output\_secret\_expiration\_days) | The number of days the Azure service principal secret remains valid before requiring renewal. |
