...
| Name | Description |
|------|-------------|
| <a name="output_azure_secret_expiration_days"></a> [azure\_secret\_expiration\_days](#output\_azure\_secret\_expiration\_days) | The ID of the service principal created for Illumio CloudSecure. |
...
| <a name="output_service_principal_id"></a> [service\_principal\_id](#output\_service\_principal\_id) | The number of days the Azure service principal secret remains valid before requiring renewal. |
<!-- END_TF_DOCS -->