...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_account_permissions"></a> [aws\_account\_permissions](#module\_aws\_account\_permissions) | ../../modules/aws_account | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_role_arn"></a> [role\_arn](#output\_role\_arn) | The ARN of the IAM role created for the Illumio CloudSecure integration. |
